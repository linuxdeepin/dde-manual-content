...
如果您尚未注册Union ID，可以在统信官方网站进行注册（支持微信扫描、手机号码等方式进行注册），注册成功并登录后，才能使用Union ID相关的功能。
...
> ![notes](../common/notes.svg) 说明：arm架构系统暂不支持启动菜单设置，mips架构系统暂不支持grub验证、不支持更换启动菜单背景图。
