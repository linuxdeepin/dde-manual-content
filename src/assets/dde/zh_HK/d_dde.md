...
初次進入深之度操作系統，會自動打開歡迎程序。您可以觀看影片了解系統功能，選擇桌面樣式、運行模式和圖標主題，進一步了解該系統。
...
單擊任務欄上的 ![shutdown](../common/system-shutdown.svg) 進入關機界面，也可以在啟動器的小窗口模式中單擊 ![poweroff_normal](../common/poweroff_normal.svg) 進入關機界面。
...
- 主菜單：單擊 ![menu](../common/icon_menu.svg) 進入主菜單。在主菜單中，您可以設置窗口主題，查看版本，反饋問題及建議，或退出控制中心。
...
設置顯示器的亮度、解像度、螢幕方向以及縮放倍數等，讓您的電腦顯示達到最佳狀態。
...
1. 在控制中心首頁，單擊 ![power_normal](../common/power_normal.svg)。
2. 點擊 **通用**。
   - 打開 **顯示剩餘使用時間及剩餘充電時間**，顯示剩餘電量及剩餘可用時間。
...
當系統存在更新時會在控制中心首頁進行提示，單擊 **更新** 按鈕 ![update](../common/update.svg) 進入 **檢查更新** 頁面，單擊 **檢查更新**，檢查完畢後，即可下載並安裝更新。除此之外，在更新設置模塊中還可以設置自動下載更新。
...
2. 單擊 **檢查更新**，進入檢查系統更新界面。
   ...
   - 如果系統存在更新，將顯示 **下載並安裝更新** 按鈕、**全部更新** 按鈕，下載數據大小和更新詳情。
