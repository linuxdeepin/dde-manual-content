...
1. 在控制中心首頁，單擊 ![account_normal](../common/account_normal.svg)。
2. 單擊當前帳戶。
3. 單擊安全問題所在行的圖標![next](../common/next.svg) ，進入安全問題設置頁面。
4. 選擇3個不同的安全問題並設置答案後，單擊 **確定**。
...
個人熱點將電腦連接的網絡信號轉換為WiFi熱點，以供一定距離內的其他設備無線上網。要開啟無線熱點，電腦必須連接到網絡並裝有支持熱點功能的無線網卡。
