...
> ![notes](../common/notes.svg) 說明：僅接入具備生物認證的硬件設備支持指紋、人臉、虹膜密碼設置。
...
如果您尚未註冊Union ID，可以在官網先進行註冊（支持微信掃描、手機號碼等註冊方式），註冊成功並登錄後，才能使用Union ID相關的功能。
...
6. 當網絡連接成功後，桌面頂部將彈出 **已連接有線連接** 的提示訊息。
...
2. 單擊 **檢查更新**，進入檢查系統更新界面。
   ...
   - 如果系統存在更新，將顯示 **下載並安裝** 按鈕、**全部更新** 按鈕，下載數據大小和更新詳情。
